...
test('ContainsParser', function() {
	...
	ok(parser instanceof ContainsParser, 'can construct a parser-chain object');
	...
	var msg = 'lorem ipsum';
	var expected = false;
	strictEqual(parser.parse(msg), expected, 'returns false is message does not contain character');
});
...
test('BeginsWithParser', function() {
	...
	ok(parser instanceof BeginsWithParser, 'can construct a parser-chain object');
	strictEqual(parser.char, 'x', 'stores provided character');
	...
	var msg = 'lorem ipsum';
	var expected = false;
	strictEqual(parser.parse(msg), expected, 'returns false is message does not begin with character');
});
...
test('EndsWithParser', function() {
	...
	ok(parser instanceof EndsWithParser, 'can construct a parser-chain object');
	strictEqual(parser.char, 'x', 'stores provided character');
	...
	var msg = 'lorem ipsum';
	var expected = false;
	strictEqual(parser.parse(msg), expected, 'returns false is message does not end with character');
});
